-- Original: https://raw.githubusercontent.com/Stebulous/solaris-ui-lib/main/source.lua --
...
else if type(get_hidden_gui) == "function" then
Solaris.Parent = get_hidden_gui()
else
...
function SolarisLib:New(Config)
    ...
    MFrame.TopBar.ButtonHolder.CloseBtn.MouseButton1Click:Connect(function()
        ...
        MainUI:Destroy() --.Visible = uitoggled
    end)
